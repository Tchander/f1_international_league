    ...
    <div class="il-regulations-contents">
      ...
      <ol class="il-regulations-contents__list">
        <li v-for="(c, index) in $options.CONTENTS" :key="index">
          <a :href="'#' + c.href" class="il-regulations-contents__link">{{ c.title }}</a>
        </li>
      </ol>
    </div>
      ...
      <ol>
          ...
          <ol>
            ...
            <li>
              ...
              <p>
                ...
                автоматически перемещаются в Лигу 1.
              </p>
              <p>
                Пилоты, занявшие 19 и 20 места, по окончанию сезона, в ЛЗ 1
                Лиги, автоматически перемещаются в Лигу 2.
              </p>
              <p>
              ...
              <p>Тестовые заезды:</p>
              <p>- 3 трассы в режиме «Заезд на время».</p>
              <p>
              ...
              <table class="il-regulations-content__table">
                ...
                <tr>
                  ...
                  <td>2</td>
                  <td>1</td>
                  <td>(1+2+2+2+2+1) /6 = 1,67 (2 ИТОГ)</td>
                </tr>
                <tr>
                  <td>Пилот Б</td>
                  <td>1:25.346 (2)</td>
            ...
            <li>Пилотам запрещается менять команду по ходу сезона.</li>
            <li>
              Запуск ГП. Сессию запускает хост в отведенное время запуска
              сессии. Администрация, на свое усмотрение, имеет право отложить
              старт сессии на 10-15 минут.
            </li>
          </ol>
        </li>
        <li id="registration">
          ...
          <ol>
            <li>
              ...
              <p>
                – в заявке на участие должны быть указаны ФИ, дата рождения, ник
                в Steam (в формате I.Ivanov (желательно реальные инициалы),
                команда, номер болида, на каком устройстве пилот проводит гонки
                (руль, геймпад и т.д.), а также скриншот профиля в игре, строго
                в определенном формате;
              </p>
              <p>– НИК ПО ХОДУ ЧЕМПИОНАТА МЕНЯТЬ ЗАПРЕЩЕНО!</p>
            </li>
            <li>
        ...
        <li id="general-rules">
          ...
          <ol>
            ...
            <li>
              КАТЕГОРИЧЕСКИ запрещается использование в Чемпионате нечестных
              приемов игры. Пилоты, которые будут в этом уличены, подлежат
              немедленной дисквалификации на весь Чемпионат, и перед
              администрацией портала будет поставлен вопрос о блокировке их
              доступа к порталу навсегда (БАН).
            </li>
            <li>
              <p>Запрещается:</p>
              <div class="il-regulations-content__subsection">
            ...
            <li>
              ...
              <div class="il-regulations-content__subsection">
                <ul>
                  ...
                  <li class="il-regulations-content__subsection-text">
                    при оповещении о введении жёлтых флагов ВСЕ пилоты ОБЯЗАНЫ 7
                    сбросить скорость, при этом убедившись, что тем самым они не
                    создадут иную аварийную ситуацию.
                  </li>
                  <li class="il-regulations-content__subsection-text">
                    Обгоны во время действия режима жёлтых флагов ЗАПРЕЩЕНЫ.
                  </li>
                </ul>
              </div>
            </li>
        ...
        <li id="score">
          ...
          <ol>
            ...
            <li>
              Дополнительно зачисляется 2 очка, за лучший круг, при попадании в
              топ10 по итоговому протоколу.
            </li>
            <li>
        ...
        <li id="sc-and-claim">
          ...
          <ol>
            ...
            <li>
              <p>Образец подачи претензии от одного участника на другого:</p>
              ...
              <p>
                Претензия рассматривается только при наличии видео или
                скриншотов, и только в указанном формате.
              </p>
            </li>
            <li>
            ...
            <li>
              Штрафы, присужденные игрой, в большинстве своем отмене не
              подлежат. Однако СК рассмотрит претензию со стороны потерпевшего
              за подобный необоснованный штраф.
            </li>
            <li>
        ...
        <li id="punishments">
          ...
          <ol>
            ...
            <li>
              ...
              <p>ЕСЛИ ШТРАФ ОТБЫТ НА ПИТ-СТОПЕ:</p>
              <p>
              ...
              <p>ЕСЛИ ШТРАФ НЕ ОТБЫТ НА ПИТ-СТОПЕ:</p>
              <p>
